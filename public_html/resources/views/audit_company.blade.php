...
@section('content')
    ...
    <div class="container">
            ...
            <form action="#" method="post" id="audit_company_form">
                ...
                <table class="table table-sm table-bordered table-hover table-checkable cell-border stripe" id="audit_company" style="margin-top: 9px !important">
                    ...
                    <tr>
                        <th>Actions</th>
                        <th>Row ID</th>
                        <th>Supplier_name_prefix</th>
                        <th>Supplier_name_full</th>
                        <th>Address_area</th>
                        <th>App_project_name</th>
                        <th>Project_status</th>
                        <th>Cust_name_prefix</th>
                        <th>Internal_project_short_name</th>
                    ...
                    @foreach($all_audit_company as $audit_company)
                                ...
                                <tr>
                                    ...
                                    <td>{{$audit_company->app_project_name}}</td>
                                    <td>{{$audit_company->project_status}}</td>
                                    <td>{{$audit_company->cust_name_prefix}}</td>
                                    <td>{{$audit_company->internal_project_short_name}}</td>
                                </tr>
                            <?php $no++?>
                    @endforeach
                    </tbody>
        ...
        <div>
            <button class="btn btn-danger" style="border-radius: 20px" onclick="create_modal();"><i class="fa fa-plus-circle"></i> ADD</button>
