            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="mobile_no" class="col-md-4 col-form-label text-md-right">{{ __('Mobile Phone No') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="requested_role" class="col-md-4 col-form-label text-md-right">{{ __('Requested Role') }}</label>
                            <div class="col-md-6">
                                <select class="form-control @error('requested_role') is-invalid @enderror" name="requested_role">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Email Address (Business)') }}</label>
