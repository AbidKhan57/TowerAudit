    ...
    <div class="container">
        ...
        <div class="card-header bg-primary text-white">
             <?php
                ...
                <ul class="breadcrumb">
                    <li><a href="{{route('home')}}">Home</a></li>
                    <li><span style="color: black">Sites</span></li>
                </ul>
                <br>
                <?php
                }
                ?>
            Working with SITES as Data Type
        </div>
        <div style="padding: 30px">
            <div class="mt-10 lg:mt-20 lg:text-center lg:max-w-xl lg:mx-auto">
                <h2 class="text-3xl font-headline tracking-tight font-bold text-gray-900 leading-tight sm:text-4xl md:text-5xl">
                    <span class="text-cyan-500">Managing Configured Sites Data</span>
                </h2>
        ...
        <div style="overflow-x:auto;">
            <form action="#" method="post" id="sites_form">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <!--begin: Datatable-->
                <table class="table table-sm table-bordered table-hover table-checkable cell-border stripe" id="sites" style="margin-top: 9px !important">
                    <thead>
                    <tr>
                        <th>ID</th>
                        <th>Actions</th>
